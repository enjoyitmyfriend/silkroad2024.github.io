    ...
    <body>
        ...
        <div class="py-4">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="animated fadeInUp mb-3 text-secondary text-center">
                            <span style="font-weight:bold">
                                Login
                            </span>
                        </h1>
                        <form name="form2" medthod="post">
                            ...
                            <input name="B1" type="submit" class="btn btn-secondary" id="B1" value="Submit">
                            <button type="button" class="btn btn-info" onClick="location.replace('registration2.php')">Register</button>
                        </form>
                    </div>
                </div>
            </div>
