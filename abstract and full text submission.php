                ...
                <div class="row pb-4">
                    <div class="col-md-12">
                        <p class="animated fadeInUp">
                            Abstract should be submitted before May 31<sup>st</sup>, 2023.<br><br>
                            ISHS authors guide on abstract and full text preparation can be found under <a href="http://www.ishs.org/authors" target="_blank">www.ishs.org/authors</a>.<br><br>
                            The online submission and review tool guidelines for authors can be found <a href="http://www.ishs.org/sites/default/files/page-documents/onlinesubmissionauthorsguide.pdf" target="_blank">here</a>.<br><br>
                        </p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="btn btn-secondary btn-block btn-lg" href="https://www.actahort.org/members/symposiar?nr=567" target="_blank">
                            Submission
                        </a>
                    </div>
                    <div class="col-md-4"></div>
