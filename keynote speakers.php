...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-12 pt-4 border-info rounded">
                        ...
                        <div class="row pt-4">
                            <div class="col-md-3">
                                <img class="img-fluid d-block mx-auto p-4"
                                        src="../images/k1.png">
                                <h4 class="pt-3">
                                    <a href="#myModalk1" data-toggle="modal">Todd Einhorn</a>
                                </h4>
        ...
        <div class="modal fade" id="myModalk1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-white bg-light">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <h3 class="text-dark text-left py-2">
                                    <span style="font-weight:bold">
                                        Todd Einhorn
                                    </span>
                                </h3>
                                <h5 class="text-dark pb-4">Michigan State University</h5>
                                <p class="text-dark">
                                    Todd...<br>
                                    Personal website:<br>
                                </p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-info" data-dismiss="modal">
                            Close
                        </button>
                    </div>
                </div>
