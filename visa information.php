    ...
    <body>
        ...
        <div class="section-parallax pt-5 pb-5">
            <div class="container">
                ...
                <div class="row pb-5">
                    <div class="animated fadeInUp col-md-12 pb-5">
                        <p>
                            Most international visitors do require a visa to enter PR China, it is best to check with the Chinese Embassy or Consulate or travel agents in your country if this is required. Visas must be affixed in the applicant's passport before departing for China.
                            <br><br>
                            If you need a letter of invitation from this conference, please contact us (ywteng@zju.edu.cn) and provide the following personal information:
                        </p>
                        <ol>
                            <li>Full name (as it appears in your travel documents)</li>
                            <li>Date of birth, gender, nationality, passport number</li>
                            <li>Institution name and address</li>
                            <li>Position at your institution</li>
                            <li>Tentative travel dates (including arrival and departure)</li>
                        </ol>
                    </div>
                </div>
            </div>
